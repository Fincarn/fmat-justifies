...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2015 a las 17:45:38
...
('Create Registries', 2, 'The user can create and post registries', NULL, NULL, 1448997303, 1448997917),
...
('Register Comitions', 2, 'The user can register the comitions from any user.', NULL, NULL, 1448998308, 1448998308),
('Register Disabilities', 2, 'The user can register the request of a disabilitie from any user.', NULL, NULL, 1448998058, 1448998058),
('Register Economic Days', 2, 'The user can register the request of an economic day from any user.', NULL, NULL, 1448997736, 1448997736),
('Secretaria Administrativa', 1, 'Secretaria Admin', NULL, NULL, 1447875856, 1447875856),
('View Comitions of All Users', 2, 'The user can see the comitions of all users of the system.', NULL, NULL, 1448998253, 1448998253),
('View Disabilities of All Users', 2, 'The user can see the disabilities of all users of the system.', NULL, NULL, 1448997972, 1448997972),
('View Economic Days of All Users', 2, 'The user can see the economic days of all users of the system.', NULL, NULL, 1448997607, 1448998002),
('View Own Registries', 2, 'The user can see his own registries.', NULL, NULL, 1448995825, 1448997886);
